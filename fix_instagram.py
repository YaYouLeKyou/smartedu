...
# <a href="...instagram...">Contact the Developer</a>
# </a>  (orphan closing tag)
# <i class="fab fa-instagram">Follow on Instagram</i>
# </a>
...
if old_broken in content:
    ...
    # Try simpler pattern
    if 'Contact the Developer' in content:
        # Find and replace just the broken part
        pass
...
print(f"Contact button: {'Contact the Developer' in final}")
print(f"Instagram complete: {'Follow on Instagram' in final and 'instagram.com/smart.edu.ai' in final}")

# Check the section
if '<a href="https://www.instagram.com/smart.edu.ai/"' in final:
    idx = final.find('<a href="https://www.instagram.com/smart.edu.ai/"')
    print(f"Instagram section: {final[idx:idx+300]}")